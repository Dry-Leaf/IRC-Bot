...
var fortuneAnswers = [...]string {
    ...
    "Courtesy begins in the home.", "Courtesy is contagious.",
    ...
    "Learn to manage your finances and live within your means.",
...
func EightBall(stored, ch string, conn *irc.Connection) {
    ...
    if fortuneReg.MatchString(stored) {
        reply := fortuneAnswers[rand.Intn(fortune_size)]
        conn.Privmsg(ch, reply)
    }
}
